...
class Main extends React.Component {
  ...
  displayTree() {
    ...
    const currData = this.dataAndMaps[this.state.subTitle].data; // modify grid based on currently collapsed trees
      ...
      row.forEach((cell, x) => {
        ...
        if (cell !== "" && cell !== "+") {
          ...
          theTree.push( /*#__PURE__*/React.createElement("image", {
            id: `${cell.includes(`(${altAbbr})`) ? altAbbr : curAbbr}icon-${itemMod}`,
            class: "main-icon",
            "data-weapon": `${cell}`,
            href: cell.includes(`(${altAbbr})`) ? `./public/icons/${altAbbr}.png` : `./public/icons/${curAbbr}.png`,
            x: paddingX + boxSpaceX * x,
            y: paddingY + boxSpaceY * y,
            width: boxWidth,
            height: boxWidth,
  ...
  tooltip() {
    ...
    return /*#__PURE__*/React.createElement("table", {
      ...
      id: "tool-name",
      colspan: "2"
    }, !hoverItem ? "*" : hoverItem.name + (altType ? ` (${this.dataAndMaps[this.state.subTitle].altFull})` : "")), /*#__PURE__*/React.createElement("th", {
      id: "compare-name",
      colspan: "1"
